...
#endif
		if (flag_need2remove && ((grid_ptr.grid[iter->first].flag == flag_interface[iboundary2]) || (grid_ptr.grid[iter->first].flag == flag_refine))) // delete nodes and its neighbours at (ilevel)
		{
...
//std::cout << "time for adding: " << t1 - t0 << std::endl;
	...
	for (D_mapint::iterator iter = map_add_surroundings.begin(); iter != map_add_surroundings.end(); ++iter)
	{
		...
		{
			if (grid_ptr.grid[morton_temp0].flag == flag_interface[iboundary2])
			{
				flag_need2add = true;
			}
		}
		...
		if (!flag_need2add)
		{
			...
			{
				if (grid_ptr.grid[morton_temp1].flag == flag_interface[iboundary2])
				{
					flag_need2add = true;
				}
			}
		...
		if (!flag_need2add)
		{
			...
			{
				if (grid_ptr.grid[morton_temp2].flag == flag_interface[iboundary2])
				{
					flag_need2add = true;
				}
			}
...
void Grid_Manager::reconstruct_numerical_boundary_removing(const unsigned int ilevel, T_grid& grid_ptr, T_node node_temp, D_mapint& map_remove_temp, D_mapint& map_add_nodes_out, D_mapint& map_remove_nodes_out)
{
	...
	for (D_mapint::iterator iter = map_remove_temp.begin(); iter != map_remove_temp.end(); ++iter)
	{
		if (grid_ptr.grid.find(iter->first) != grid_ptr.grid.end())
		{
			if ((grid_ptr.grid[iter->first].flag == flag_interface[iboundary2]) || (grid_ptr.grid[iter->first].flag == flag_refine))
			{
				if (map_remove_out_temp.find(iter->first) == map_remove_out_temp.end())
				{
					map_remove_out_temp.insert({ iter->first , flag_remove });
			...
			//(center)
			if (grid_ptr.grid[iter->first].flag == flag_interface[iboundary2])
			{
			...
			if (grid_ptr.grid.find(morton_temp0) != grid_ptr.grid.end())
			{
				...
				else if (grid_ptr.grid[morton_temp0].flag == flag_interface[iboundary1])
				{
			...
			if (grid_ptr.grid.find(morton_temp1) != grid_ptr.grid.end())
			{
				...
				else if (grid_ptr.grid[morton_temp1].flag == flag_interface[iboundary1])
				{
			...
			if (grid_ptr.grid.find(morton_temp2) != grid_ptr.grid.end())
			{
				...
				else if (grid_ptr.grid[morton_temp2].flag == flag_interface[iboundary1])
				{
	...
	for (D_mapint::iterator iter = map_remove_out_temp.begin(); iter != map_remove_out_temp.end(); ++iter)
	{
		...
		if (grid_ptr.grid.find(morton_temp0) != grid_ptr.grid.end())
		{
			grid_ptr.grid[morton_temp0].flag = flag_interface[iboundary2];
			if (grid_ptr.fine2coarse.at(iboundary2).find(morton_temp0) == grid_ptr.fine2coarse.at(iboundary2).end())
			{
		...
		if (grid_ptr.grid.find(morton_temp1) != grid_ptr.grid.end())
		{
			grid_ptr.grid[morton_temp1].flag = flag_interface[iboundary2];
			if (grid_ptr.fine2coarse.at(iboundary2).find(morton_temp1) == grid_ptr.fine2coarse.at(iboundary2).end())
			{
		...
		if (grid_ptr.grid.find(morton_temp2) != grid_ptr.grid.end())
		{
			grid_ptr.grid[morton_temp2].flag = flag_interface[iboundary2];
			if (grid_ptr.fine2coarse.at(iboundary2).find(morton_temp2) == grid_ptr.fine2coarse.at(iboundary2).end())
			{
	...
	for (D_mapint::iterator iter = remove_temp.begin(); iter != remove_temp.end(); ++iter)
	{
		...
		{
			if (grid_ptr.grid[morton_temp0_ilevel_1].flag == flag_interface[iboundary2])
			{
				if (grid_ptr.grid.find(morton_temp0) != grid_ptr.grid.end())
				{
					if (grid_ptr.fine2coarse.at(iboundary2).find(morton_temp0) == grid_ptr.fine2coarse.at(iboundary2).end())
			...
			else
			{
				...
				if (grid_ptr.grid.find(morton_temp0) != grid_ptr.grid.end())
				{
					grid_ptr.grid[morton_temp0].flag = flag_interface[iboundary1];
					if (grid_ptr.fine2coarse.at(iboundary1).find(morton_temp0) == grid_ptr.fine2coarse.at(iboundary1).end())
					{
		...
		{
			if (grid_ptr.grid[morton_temp1_ilevel_1].flag != flag_interface[iboundary2])
			{
				if (grid_ptr.grid.find(morton_temp1) != grid_ptr.grid.end())
				{
					grid_ptr.grid[morton_temp1].flag = flag_interface[iboundary1];
		...
		if (grid_ptr.grid.find(morton_temp2_ilevel_1) != grid_ptr.grid.end())
		{
			if (grid_ptr.grid.find(morton_temp2) != grid_ptr.grid.end())
			{
				grid_ptr.grid[morton_temp2].flag = flag_interface[iboundary1];
			...
			if (grid_ptr.grid[morton_temp2_ilevel_1].flag != flag_interface[iboundary2])
			{
	...
	//	@todo use flag,i.e. x0x1y0y1z0z1 in previous for loop, to identify if flag of nodes is flag_interface[2]
	for (D_mapint::iterator iter = map_cell_delete.begin(); iter != map_cell_delete.end(); ++iter)
	{
		...
		if (grid_ptr.grid.find(morton_corner) == grid_ptr.grid.end() || grid_ptr.grid[morton_corner].flag == flag_interface[iboundary2])
		{
		}
		else
		{
		...
		if (grid_ptr.grid.find(morton_temp0_ilevel_1) == grid_ptr.grid.end() || grid_ptr.grid[morton_temp0_ilevel_1].flag == flag_interface[iboundary2])
		{
		}
		else
		{
		...
		if (grid_ptr.grid.find(morton_temp1_ilevel_1) == grid_ptr.grid.end() || grid_ptr.grid[morton_temp1_ilevel_1].flag == flag_interface[iboundary2])
		{
		}
		else
		{
		...
		if (grid_ptr.grid.find(morton_temp2_ilevel_1) == grid_ptr.grid.end() || grid_ptr.grid[morton_temp2_ilevel_1].flag == flag_interface[iboundary2])
		{
		}
		else
		{
		...
		if (bool_need2delete)
		{
			...
			if (grid_ptr.grid.find(morton_corner) != grid_ptr.grid.end())
			{
				...
				if (grid_ptr.grid.find(morton_temp0_inner) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp0_inner].flag != flag_interface[iboundary2])
				{
				...
				if (bool_need2delete_inner && grid_ptr.grid.find(morton_temp1_inner) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp1_inner].flag != flag_interface[iboundary2])
				{
					bool_need2delete_inner = false;
				}
				...
				if (bool_need2delete_inner && grid_ptr.grid.find(morton_temp2_inner) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp2_inner].flag != flag_interface[iboundary2])
				{
					bool_need2delete_inner = false;
				}
				...
				if (bool_need2delete_inner && grid_ptr.grid.find(morton_temp0_inner) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp0_inner].flag != flag_interface[iboundary2])
				{
					bool_need2delete_inner = false;
				}
			...
			if (grid_ptr.grid.find(morton_temp0_ilevel_1) != grid_ptr.grid.end())
			{
				...
				// (-x, -y) 
				morton_temp1_inner = Morton_Assist::find_y0(morton_temp0_inner, ilevel_1);
				if (grid_ptr.grid.find(morton_temp1_inner) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp1_inner].flag != flag_interface[iboundary2])
				{
					bool_need2delete_inner = false;
				}
				...
				// (-x, -y, -z) 
				morton_temp2_inner = Morton_Assist::find_z0(morton_temp1_inner, ilevel_1);
				if (grid_ptr.grid.find(morton_temp2_inner) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp2_inner].flag != flag_interface[iboundary2])
				{
					bool_need2delete_inner = false;
				}
	...
	for (D_mapint::iterator iter = iboundary2_temp.begin(); iter != iboundary2_temp.end(); ++iter)
	{
		if (grid_ptr.grid.find(iter->first) != grid_ptr.grid.end())
		{
			if (grid_ptr.grid[iter->first].flag != flag_interface[iboundary1])
			{
				if (grid_ptr.fine2coarse.at(iboundary2).find(iter->first) == grid_ptr.fine2coarse.at(iboundary2).end())
				{
					grid_ptr.grid[iter->first].flag = flag_interface[iboundary2];
			...
			{
				morton_temp0 = Morton_Assist::find_x0(iter->first, ilevel);
				bool_x_temp0 = grid_ptr.grid.find(morton_temp0) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp0].flag == flag_interface[iboundary2];
				if (bool_x_temp0)
				{
					morton_temp1 = Morton_Assist::find_x1(iter->first, ilevel);
					bool_x_temp1 = grid_ptr.grid.find(morton_temp1) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp1].flag == flag_interface[iboundary2];
				}

				morton_temp0 = Morton_Assist::find_y0(iter->first, ilevel);
				bool_y_temp0 = grid_ptr.grid.find(morton_temp0) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp0].flag == flag_interface[iboundary2];
				if (bool_y_temp0)
				{
					morton_temp1 = Morton_Assist::find_y1(iter->first, ilevel);
					bool_y_temp1 = grid_ptr.grid.find(morton_temp1) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp1].flag == flag_interface[iboundary2];
				}

				morton_temp0 = Morton_Assist::find_z0(iter->first, ilevel);
				bool_z_temp0 = grid_ptr.grid.find(morton_temp0) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp0].flag == flag_interface[iboundary2];
				if (bool_z_temp0)
				{
					morton_temp1 = Morton_Assist::find_z1(iter->first, ilevel);
					bool_z_temp1 = grid_ptr.grid.find(morton_temp1) != grid_ptr.grid.end() && grid_ptr.grid[morton_temp1].flag == flag_interface[iboundary2];
				}
...
void Grid_Manager::reconstruct_numerical_boundary_adding(const unsigned int ilevel, T_grid& grid_ptr, T_node node_temp, D_mapint& map_add_temp, D_mapint& map_add_nodes_out, D_mapint& map_remove_nodes_out)
{
	...
	for (D_mapint::iterator iter = map_surrounding_nodes.begin(); iter != map_surrounding_nodes.end(); ++iter)
	{
		...
		{
			grid_ptr.grid[iter->first].flag = flag_interface[iboundary2];
			map_is_boundary.insert({ iter->first, flag_interface[iboundary2] });
		}
	}
	...
	for (D_mapint::iterator iter = map_is_boundary.begin(); iter != map_is_boundary.end(); ++iter)
	{
		...
		if (grid_ptr.grid.find(morton_temp0_ilevel_1) != grid_ptr.grid.end())
		{
			if (grid_ptr.grid[morton_temp0_ilevel_1].flag == flag_interface[iboundary2])
			{
				...
				{
					node_temp.flag = flag_interface[iboundary2];
					grid_ptr.grid.insert({ morton_temp0 , node_temp });
#if (C_CHECK_MORTON_BOUNDARY == 1)
					if ((morton_temp0 & Morton_Assist::xmorton_ref.at(ilevel).at(1)) == Morton_Assist::mortonx_min)
					{
		...
		if (grid_ptr.grid.find(morton_temp0_ilevel_1) != grid_ptr.grid.end())
		{
			if (grid_ptr.grid[morton_temp0_ilevel_1].flag == flag_interface[iboundary2])
			{
				...
				if (grid_ptr.fine2coarse.at(iboundary2).find(morton_temp0) == grid_ptr.fine2coarse.at(iboundary2).end())
				{
					grid_ptr.fine2coarse.at(iboundary2).insert({ morton_temp0, flag_interface[iboundary2] });
				}
			}
		}
